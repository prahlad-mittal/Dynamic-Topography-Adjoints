...
#
# The example is configured at $Ra_0 = 5e4$. Boundary conditions are free-slip at the surface and base of the domain. The viscosity depends on T.
#
...
dtopo = Function(Q, name="Dynamic_Topography")
...
# We also setup the surface_force_solver.
...
for timestep in range(0, timesteps):
    ...
    if timestep % output_frequency == 0:        
        ...
        output_file.write(*z.subfunctions, T, mu_field, dtopo)
